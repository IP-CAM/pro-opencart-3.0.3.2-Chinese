	...
	public function map() {
		...
		switch ($range) {
			default:
				...
				break;
			case 'day':
				$results = $this->model_extension_dashboard_china_map->getTotalOrdersZoneByDay();
				break;
			case 'week':
				$results = $this->model_extension_dashboard_china_map->getTotalOrdersZoneByWeek();
				break;				
			case 'month':
				$results = $this->model_extension_dashboard_china_map->getTotalOrdersZoneByMonth();
				break;
			case 'year':
				$results = $this->model_extension_dashboard_china_map->getTotalOrdersZoneByYear();
				break;
		}
